...
TOKEN = '8175209682:AAGS625Jq8QO1Fw7Bbi6900guSg_E6VUCx8'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002568610684
CHANNEL_ID = -1002568610684
error_channel_id = -1002568610684
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./moul {target_ip} {target_port} {duration} 80")
